...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
	...
	{
	//	if(InventoryStatus[playerid] == false) return SendClientMessage(playerid, -1,  "{ffffff}[{4682b4}Inv{2e8b57}ent{ff1493}ory{ffffff}] Tqven Ar Gaqvt Gaxsnili Inventory");
